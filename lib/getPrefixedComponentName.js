...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs-extra", "path", "chokidar", "chalk", "globby", "./utils/utils", "./utils/path", "./utils/html", "./prefixesConfig", "./platformConfig", "./index"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.init = exports.PageMap = exports.PageOrComponentMap = exports.watchJson = exports.watchHtml = exports.checkUpdatePackIgnore = exports.updateUsingComponentsInJson = exports.addPageOrComponent = void 0;
    ...
    function resolvePageOrComponentInfo(htmlPath, json) {
        const pageOrComponent = json.component
            ? { isComponent: true, componentName: '', path: htmlPath, json, usingComponents: [] }
            : { isComponent: false, path: htmlPath, json, usingComponents: [] };
    ...
    function removePageOrComponent(htmlPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const json = yield fs.readJSON((0, path_1.toJSONPath)(htmlPath), 'utf-8');
            if (json.component) {
    ...
    function recordUsingComponentsOf(pageOrComponent) {
        if (pageOrComponent.componentName) {
        ...
        pageOrComponent.usingComponents.forEach((item) => {
            ...
            const comp = exports.PageOrComponentMap.get(relativeCompHtmlPath);
            if (comp) {
                // 组件引用自己
    ...
    function watchHtml(options) {
        ...
        chokidar
            ...
            yield updateUsingComponentsInJson((0, path_1.formatPath)(path), options === null || options === void 0 ? void 0 : options.tabWidth);
        }));
    }
    exports.watchHtml = watchHtml;
    function watchJson($options) {
        console.log(chalk.green('start watching json ...'));
        const options = Object.assign({}, index_1.DefaultOptions, $options);
        ...
        chokidar
            ...
            yield (0, index_1.onJsonFileChange)(jsonPath, options);
        }))
            ...
            if (options.updateIgnore) {
                const ignoreUpdated = yield checkUpdatePackIgnore(options.tabWidth);
