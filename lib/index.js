...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs-extra", "path", "chokidar", "chalk", "globby", "./utils/utils", "./utils/path", "./utils/html", "./prefixesConfig", "./platformConfig"], factory);
    }
    ...
    function addPageOrComponent(htmlPath, json) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!json) {
                json = yield fs.readJSON((0, path_1.toJSONPath)(htmlPath), 'utf-8');
            }
            ...
            if (json.component) {
                ...
                packageComponentMap.set(componentName, { name: componentName, path: (0, path_1.removePathExtension)(htmlPath) });
            }
        });
    }
    ...
    function getUsingComponentInfo(compPath) {
        if (fs.existsSync((0, path_1.toHtmlPath)(compPath))) {
            return {
        ...
        if (!compPath.endsWith('/index')) {
            ...
            if (fs.existsSync((0, path_1.toHtmlPath)(compPathWithIndex))) {
                return {
    ...
    function resolveUsingComponents(htmlPath, json) {
        ...
        Object.entries(usingComponents).forEach(([name, compPath]) => __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(chalk.red(`Can't find component of :`), compPath, chalk.blue((0, path_1.toJSONPath)(htmlPath)));
        }));
    }
    ...
    function recordUsingComponentsOf(pageOrComponent) {
        ...
        pageOrComponent.usingComponents.forEach((item) => {
            const relativeCompHtmlPath = (0, path_1.toHtmlPath)(item.path).replace(/^\//, '');
